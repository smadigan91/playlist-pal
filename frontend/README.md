...
To run the frontend without spinning up the backend (not suggested) you need to do the following. NOTE: Make sure you are in the `/frontend` folder for these commands to work:
